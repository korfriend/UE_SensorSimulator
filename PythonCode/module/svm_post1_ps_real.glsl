...
vec4 blendArea(int camId0, int camId1, vec3 pos, mat4 viewProjs[4], int caseId, float weightId0, 
                int semantic, int debugMode) {
    
    if(semantic == 2) weightId0 = 1.0;
